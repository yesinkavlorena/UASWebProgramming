...
if(isset($_POST['submit'])) {
    ...
    if($count == 0) {
        ...
        mysqli_query($mysqli, "INSERT INTO users(username,password,level_user) VALUES('$username','$hash','$level_user')"); 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="mb-3">
                ...
                <input type="level_user" name="level_user" class="form-control" placeholder="level user">
            </div>
            <br>
