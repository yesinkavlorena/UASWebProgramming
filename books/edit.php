...
{  
   ...
   mysqli_query($mysqli, "UPDATE books SET author='$author',title='$title', stock='$stock', type='$type', year='$year', description='$description', date_updated=NOW() WHERE ISBN=$isbn");
