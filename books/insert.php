...
if(isset($_POST['submit'])) {
    ...
    if($count == 0) {
        ...
        mysqli_query($mysqli, "INSERT INTO books(ISBN, author, title, price, type, year, description, date_added) VALUES('$isbn','$author','$title','$price', '$type', '$year', '$description', NOW())"); 
